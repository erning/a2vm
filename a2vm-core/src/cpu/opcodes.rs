...
/// 6502 opcode table with mnemonics, addressing modes, cycle counts, and page penalty flags.
///
/// References:
/// - NMOS 6502 opcodes: http://www.oxyron.de/html/opcodes02.html
/// - Illegal opcodes: https://wiki.nesdev.com/w/index.php/CPU_unofficial_opcodes
pub static OPCODES: [OpcodeInfo; 256] = [
    ...
    ill(),                        // 82
    op(SAX, IndirectX, 6, false), // 83 - SAX
